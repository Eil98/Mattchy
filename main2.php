        ...
        <div id="navbar" class="">
            ...
            <div id="wrapIcon">
                ...
                <div id="hamb">
                    ...
                    <div id="logoMob">//TODO logo click->Home
            ...
            <ul>
                ...
                <li id="logoDex"><a href="#" id="logoHome"><img src="LogoMattchy2.png" width="58"></a></li>                 <!--TODO logo click->Home-->
                ...
                <li><a href="#"><i class="fas fa-industry"></i> <p style="display: inline-block; color: white;margin-bottom: 0px">Brands</p></a></li>
                <li id="shopCart"><a href="#" id="shopCartTrigg"><i class="fa fa-shopping-cart"></i> <p style="display: inline-block; color: white;margin-bottom: 0px">Shopping-Cart</p></a></li>

                <li class="subMenu" id="submenu-user">
                    <div id="normalmenu">
                    <a href="#" class="openBtnLog"><i class="fas fa-user"></i> <p style="display: inline-block; color: white;margin-bottom: 0px;">Sign Up/Log in</p></a>
                    </div>
                    <div  id="usermenu">
                        ...
                        <ul>
                            ...
                            <li><a href="#" id="logOut"><p style=" color:#ffffff;margin-bottom: 0px;">Logout</p></a></li>
                        </ul>
                    </div>
                </li>
...
-->
    ...
    <script src="loginProcess2.js"></script>
